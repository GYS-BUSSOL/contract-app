<script setup>
import ApprovalCompletedList from '@/views/apps/approval/lvl2/completed/ApprovalCompletedList.vue';
import ApprovalOnGoingList from '@/views/apps/approval/lvl2/onGoing/ApprovalOnGoingList.vue';
