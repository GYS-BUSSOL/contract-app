...
class WorkCenterController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'status' => 200,
                'message' => 'Successfully retrieved area work center data',
                'data' => [
                    'rows' => $dataGet,
            ...
            return response()->json([
                'status' => 500,
                'message' => 'Failed to retrieve area work center data',
                'data' => [
                    'rows' => [],
                    'total_record' => 0
                ],
    ...
    public function add(Request $request)
    {
        ...
        try {
            $validated['group_dimension'] = "Work Center";
            $validated['is_active'] = 0;
            $this->mbcw->create($validated);

            return response()->json([
                'status' => 200,
                'message' => 'Area work center created successfully'
            ], 200);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 500,
                'error' => 'Server error',
                'message' => 'Area work center failed to create',
            ], 500);
        }
    }
    ...
    public function edit(int $id)
    {
        try {
            ...
            if (empty($areaCC)) {
                return response()->json([
                    "status" => 404,
                    "message" => "Area work center not found",
                ], 404);
            }
            return response()->json([
                "status" => 200,
    ...
    public function update(Request $request, int $id)
    {
        ...
        try {
            ...
            if ($mbcw->update($validated)) {
                return response()->json([
                    "status" => 200,
                    "message" => "Successfully updated area work center data",
                ], 200);
            }
        } catch (\Exception $e) {
            return response()->json([
                "status" => 500,
                "message" => "Failed to updated area work center data",
                "error" => "Server error",
            ], 500);
        }
    }
    ...
    public function destroy(int $id)
    {
        try {
            ...
            if ($mbcw->delete()) {
                return response()->json([
                    "status" => 200,
                    "message" => "Successfully deleted area work center data"
                ], 200);
            }
        } catch (\Exception $e) {
            return response()->json([
                "status" => 500,
                "message" => "Failed to delete area work center data",
                "error" => "Server error",
            ], 500);
        }
    }
